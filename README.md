...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-shinyheatmaply-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14427&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-shinyheatmaply-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-shinyheatmaply` can be installed with:

```
conda install r-shinyheatmaply
```

It is possible to list all of the versions of `r-shinyheatmaply` available on your platform with:
